...
export VARS='
BASE_IMAGE=openjdk:11-jdk GRADLE_VERSION=5.2 IMAGE_TAG="openjdk-11-gradle-5.2"
BASE_IMAGE=openjdk:11-jdk GRADLE_VERSION=5.1 IMAGE_TAG="openjdk-11-gradle-5.1"
BASE_IMAGE=openjdk:8-jdk GRADLE_VERSION=5.2 IMAGE_TAG="openjdk-8-gradle-5.2"
